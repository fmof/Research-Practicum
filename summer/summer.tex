...
% This is a very very very rough section, just wanted to throw something in here before I go to bed
\begin{align*}
...
$I\left(X\right)$ is the information content of $X$ and $E\left[X\right]$ is the expected value of random variable $X$.
